...
func Generate(input io.Reader, parser Parser, structName string, pkgName string, tags []string, subStruct bool, convertFloats bool) ([]byte, error) {
